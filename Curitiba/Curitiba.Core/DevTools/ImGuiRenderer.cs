// Vendored from the ImGui.NET sample (ImGui.NET.SampleProgram.XNA), as recommended by the
// official MonoGame "Debug UI" tutorial. Compiled only in desktop Debug builds.
